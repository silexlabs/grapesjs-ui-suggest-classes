> This code is part of a bigger project: [Silex v3](https://www.silexlabs.org/silex-v3-kickoff/) which aims to be a free/libre alternative to webflow. PR welcome.
